...
function Library:clear()
    for _, object in CoreGui:GetChildren() do
        if object.Name == "AtlasDev" then --default Visual
            object:Destroy()
        end
    end
end
...
function Library:save_flags()
    ...
    writefile("AtlasDev/" .. game.GameId .. ".lua", flags)
end

function Library:load_flags()
    if not isfile("AtlasDev/" .. game.GameId .. ".lua") then Library.save_flags() return end
    
    local flags = readfile("AtlasDev/" .. game.GameId .. ".lua")
...
function Library.__init()
    ...
    container.Name = "AtlasDev" ----default Visual
...
game:GetService("UserInputService").InputEnded:Connect(onInputEnded)
    ...
    function Tab:update_sections(selected_sections)
		...
		if selected_sections.left_section then
			selected_sections.left_section.Visible = true
		end
		if selected_sections.right_section then
			selected_sections.right_section.Visible = true
		end
	end
	...
	function Tab:open_tab(bebra)
		...
		for _, object in ipairs(tabs:GetChildren()) do
			if object.Name == "Tab" and object ~= bebra.tab then
